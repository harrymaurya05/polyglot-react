...
- 100 texts × 5 languages = 500 API calls **every time**
- Expensive 💸
- Slow 🐌
- Wasteful ♻️
...
- First build: 100 texts × 5 languages = 500 API calls
...
✅ Extracted 127 unique translatable texts
...
🔄 Translating 127 texts...
  → Translating to es... ✅
  → Translating to fr... ✅
  → Translating to de... ✅
  (... 5 languages × 127 texts = 635 API calls)
...
```
📄 Found 51 files to scan
✅ Extracted 128 unique translatable texts
💾 Saved to src/translations/texts.json
...
🔄 Translating 1 text...
  → Translating to es... ✅
  → Translating to fr... ✅
  (... 5 languages × 1 text = 5 API calls)
...
**Result**: 90-99% reduction in translation costs while maintaining perfect translations! 🎉
